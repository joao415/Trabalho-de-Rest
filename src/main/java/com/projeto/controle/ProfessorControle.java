...
public class ProfessorControle {
	...
	@GetMapping("")
	public Iterable<ProfessorModelo> obter() {
		return acao.findAll();
	}

	@GetMapping("/{codigo}")
	public Optional<ProfessorModelo> obterPorId(@RequestBody int codigo) {
		return acao.findById(codigo);
	}

	@PutMapping("")
	public ProfessorModelo alterar(@RequestBody ProfessorModelo obj) {
		return acao.save(obj);
	}
